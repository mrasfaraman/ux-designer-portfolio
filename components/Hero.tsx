    ...
    <div className="relative w-full max-w-md mx-auto select-none">
      ...
      <div className="relative rounded-3xl border border-white/10 overflow-hidden"
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/5">
          ...
          <div className="text-xs text-white/30 font-mono">finflow.figma</div>
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="w-10 h-10 rounded-full border-2 border-[#8b5cf6]/40 overflow-hidden"
          ...
          <div className="rounded-2xl p-4 relative overflow-hidden"
            ...
            <div className="text-2xl font-bold text-white mb-3">$24,581.00</div>
            <div className="flex gap-3">
              <div className="flex-1 bg-white/20 rounded-xl py-2 text-center text-xs text-white font-medium">Send</div>
              <div className="flex-1 bg-white/20 rounded-xl py-2 text-center text-xs text-white font-medium">Receive</div>
              <div className="flex-1 bg-white/20 rounded-xl py-2 text-center text-xs text-white font-medium">Pay</div>
            </div>
            {/* Pattern */}
          ...
          <div className="space-y-3">
            {[
              { label: "Netflix", sub: "Entertainment", amount: "-$15.99", color: "#e50914" },
              { label: "Spotify", sub: "Music", amount: "-$9.99", color: "#1db954" },
              { label: "Salary", sub: "Income", amount: "+$5,200", color: "#34d399" },
            ].map((t) => (
              <div key={t.label} className="flex items-center gap-3">
                ...
                <div className="text-xs font-semibold" style={{ color: t.amount.startsWith("+") ? "#34d399" : "rgba(255,255,255,0.6)" }}>
                  {t.amount}
                </div>
              </div>
            ))}
          ...
          <div>
            <div className="flex justify-between text-[10px] text-white/30 mb-2">
              <span>Spending</span><span>This Month</span>
            </div>
      ...
      <div className="absolute -top-4 -right-4 glass rounded-2xl px-4 py-2.5 border border-white/10 shadow-xl">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-[10px] text-white/40">User Testing</div>
            <div className="text-xs text-white font-medium">+48% conversion</div>
          </div>
        </div>
      </div>

      {/* Floating badge — bottom left */}
      <div className="absolute -bottom-4 -left-4 glass rounded-2xl px-4 py-2.5 border border-white/10 shadow-xl">
        <div className="flex items-center gap-2">
          <div className="flex -space-x-1.5">
            {["#8b5cf6", "#f472b6", "#06b6d4"].map((c, i) => (
              <div key={i} className="w-6 h-6 rounded-full ring-2 ring-[#0f0f18]"
                style={{ background: c }} />
            ))}
          </div>
          <div className="text-xs text-white/60">12 feedbacks</div>
        </div>
      </div>
    </div>
  );
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-[#94a3b8] max-w-lg mb-10 leading-relaxed">
              I&apos;m <span className="text-white font-medium">Alex Morgan</span>, a UI/UX designer
              turning complex problems into elegant, user-centered solutions — from wireframes to
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <button
                ...
                style={{ background: "linear-gradient(135deg, #8b5cf6 0%, #06b6d4 100%)", boxShadow: "0 0 30px rgba(139,92,246,0.4)" }}
              >
                View My Work
